...
export const WORK_EXPERIENCE: WorkExperience[] = [
  {
    ...
    tags: ['Main Job'],
    teaser:
      '50+ specialized agents resolving compound guest requests in one turn, over the BERT and FastText models underneath.',
    description:
...
export const PROFESSIONAL_SUMMARY = {
  paragraphs: [
    "I've spent the last {yoe} years at Quinta, building the AI behind hotel guest communication: the classifiers and retrieval underneath it as much as the LLM systems on top.",
