                  ...
                  <div className="flex flex-col items-end gap-1 ml-2 shrink-0 self-stretch justify-between">
                    ...
                    {cert.link && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative inline-flex items-center gap-1 text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors whitespace-nowrap"
                      >
                        View
                        <svg width="12" height="12" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3 w-3">
                        ...
                        <span className="absolute bottom-0 left-0 block h-[1px] w-full max-w-0 bg-zinc-600 transition-all duration-200 group-hover:max-w-full dark:bg-zinc-400"></span>
                      </a>
                    )}
                  </div>
                </div>
